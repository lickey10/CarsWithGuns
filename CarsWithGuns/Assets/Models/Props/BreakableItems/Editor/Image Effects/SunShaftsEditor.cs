...
public class SunShaftsEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        {
            GUILayout.Label("Current camera mode: " + (this.target as SunShafts).GetComponent<Camera>().depthTextureMode, EditorStyles.miniBoldLabel);
        }
		...
		*/
        ...
        EditorGUILayout.BeginHorizontal();
        EditorGUILayout.PropertyField(this.sunTransform, new GUIContent("Shafts caster", "Chose a transform that acts as a root point for the produced sun shafts"));
        ...
        EditorGUILayout.EndHorizontal();
        EditorGUILayout.Separator();
        EditorGUILayout.PropertyField(this.sunColor, new GUIContent("Shafts color"));
        this.maxRadius.floatValue = 1f - EditorGUILayout.Slider("Distance falloff", 1f - this.maxRadius.floatValue, 0.1f, 1f);
        EditorGUILayout.Separator();
        this.sunShaftBlurRadius.floatValue = EditorGUILayout.Slider("Blur size", this.sunShaftBlurRadius.floatValue, 1f, 10f);
        this.radialBlurIterations.intValue = EditorGUILayout.IntSlider("Blur iterations", this.radialBlurIterations.intValue, 1, 3);
        EditorGUILayout.Separator();
        EditorGUILayout.PropertyField(this.sunShaftIntensity, new GUIContent("Intensity"));
        this.useSkyBoxAlpha.floatValue = EditorGUILayout.Slider("Use alpha mask", this.useSkyBoxAlpha.floatValue, 0f, 1f);
