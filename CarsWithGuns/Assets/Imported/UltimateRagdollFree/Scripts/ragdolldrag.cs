...
[System.Serializable]
public partial class ragdolldrag : MonoBehaviour
{
    ...
    public virtual void Update()
    {
        ...
        if (!this.springJoint)
        {
            ...
            this.springJoint = go.AddComponent<SpringJoint>() as SpringJoint;
    ...
    {
        Camera varcamera = null;
        varcamera = (Camera) this.gameObject.GetComponent(typeof(Camera));
        if (varcamera)
        {
            return varcamera;
        }
