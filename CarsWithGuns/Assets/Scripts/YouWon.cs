...
public class YouWon : MonoBehaviour {
	...
	void OnGUI()
	{
        ...
        //drop shadow
        customGuiStyle.normal.textColor = Color.black;
        GUI.Box(new Rect(logoX + 3, logoY + 53, 450, 30), "More Levels Coming Soon!", customGuiStyle);

        customGuiStyle.normal.textColor = Color.blue;
        GUI.Box(new Rect(logoX, logoY + 50, 450, 30), "More Levels Coming Soon!", customGuiStyle);
